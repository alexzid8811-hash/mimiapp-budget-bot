(() => {
  ...
  function injectSettingsUI() {
    ...
    help.textContent = "Стартовый капитал — деньги без отпускных, которыми вы располагаете на начало выбранного дня. Отпускные приложение возьмёт из раздела выше и отдельно покажет в буфере. Всё сверх безопасной суммы на день останется для будущих обязательных платежей и слабых выплат.";
