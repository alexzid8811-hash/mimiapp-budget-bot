...
def budget_income_events(uid, start, end):
    ...
    """
    result = []
    for event in income_events(uid, start - timedelta(days=1), end):
...
def budget_income_map(uid, start, end, include_manual=True):
