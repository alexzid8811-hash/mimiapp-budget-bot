(() => {
  ...
  function render(state) {
    ...
    // Keep the main value negative on overspending, as requested by the user.
    $("dailyAvailable").textContent=money(left<0 ? left : target);
    ...
    $("reserveTarget").textContent="из "+money(peak);
